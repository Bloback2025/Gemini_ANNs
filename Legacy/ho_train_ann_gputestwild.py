#!/usr/bin/env python3
"""
ho_train_ann_gputest.py
GPU-capable HO ANN trainer for retest1. Produces model_final.keras, model_best.keras, scaler.json, RUNLOG.json.
"""
...
# CLI
# -------------------------
parser = argparse.ArgumentParser(description="HO ANN GPU trainer (retest1).")
