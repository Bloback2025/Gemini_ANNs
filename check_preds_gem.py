...
Path: C:\Users\loweb\AI_Financial_Sims\Gemini_ANNs\check_preds_gem.py

Annotations:
- This is a clean rewrite of the legacy check_preds.py script.
- Updated to point paths directly to the new Gemini_ANNs project root and its local artifacts directory.
- Automatically handles date alignment, dynamically identifies prediction and actual close columns, and calculates MAE, RMSE, and sample comparative tables.
"""
...
PRED_PATH = Path(r"C:\Users\loweb\AI_Financial_Sims\Gemini_ANNs\artifacts\preds_from_model.csv")
TEST_PATH = Path(r"C:\Users\loweb\AI_Financial_Sims\Gemini_ANNs\artifacts\processed_test.csv")
